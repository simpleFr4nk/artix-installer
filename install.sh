...
# Chroot
sudo cp chroot-part.sh /mnt/                    # copy the installer script for the chroot part
sudo "$(chroot-vars)" artix-chroot /mnt /bin/bash -c 'sh chroot-part.sh ; rm chroot-part.sh ; exit'
